 ...
 * Override with NEXT_PUBLIC_USDC_ADDRESS if you need a different token.
 */
...
/**
 * ProfileRegistry address. Must be set for writes to work.
 * NEXT_PUBLIC_PROFILE_REGISTRY_ADDR is used both client & server.
 */
