...
export const CREATOR_HUB: Address = '0x49b9a469d8867e29a4e6810aed4dad724317f606';
...
export const CREATOR_HUB_ABI = [
  ...
  { "type":"function","stateMutability":"view","name":"BPS_DENOMINATOR","inputs":[],"outputs":[{"type":"uint256"}] },
  { "type":"function","stateMutability":"view","name":"getCreatorPlanIds","inputs":[{"type":"address","name":"creator"}],"outputs":[{"type":"uint256[]"}] },
  { "type":"function","stateMutability":"view","name":"getCreatorPostIds","inputs":[{"type":"address","name":"creator"}],"outputs":[{"type":"uint256[]"}] },
